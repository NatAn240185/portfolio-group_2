...
import icon from '../img/my-projects//proj-arrow.svg';
const allProjects = [
  {
    img: image1,
    title: 'English excellence webservice ',
    technologies: 'React, JavaScript, Node JS, Git',
    github: 'https://github.com/NatAn240185/portfolio-group_2',
  },
  {
    img: image2,
  ...
  for (let i = 0; i < projectsPerLoad; i++) {
    ...
    li.innerHTML = `
      ...
      <div class="item-text">
        ...
        <a href="${project.github}" class="visit" target="_blank">Visit<svg class="visit-icon" >
        <use href="${icon}#icon-visit">
        </svg></a>
      </div>
    `;
